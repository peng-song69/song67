...
from .models import Product, Order, OrderItem, Discount # Added Discount here
...
class DiscountInline(admin.StackedInline):
    """បង្ហាញការបញ្ចុះតម្លៃនៅក្នុងទំព័រ Order"""
    model = Discount
    extra = 0
# -----------------------------
...
class OrderAdmin(admin.ModelAdmin):
    ...
    ordering      = ['-created_at']
    inlines       = [OrderItemInline, DiscountInline]    # Added DiscountInline here